...
public class TransportAndAutoActivity extends AppCompatActivity {
    ...
    public static final String LOG_TAG=TransportAndAutoActivity.class.getSimpleName();
    WebView webView;
    String result="";
    ...
    public class ParseTransportAndAutoWebPage extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... strings) {
            Document document;
            try {
                document= Jsoup.connect("http://www.frumtoronto.com/BusinessDirectory.asp?Section=14").get();
